...
const AnalyticsPanel = ({ data, isOpen, isMobile, mobilePanelHeight, onClose, onSelectCountry, selectedIso }) => {
  ...
  const panelClassName = isMobile
    ? `fixed left-0 right-0 bottom-0 z-[95] transform transition-transform duration-300 ${isOpen ? 'translate-y-0' : 'translate-y-full'}`
  ...
  return (
    <div className={panelClassName} style={isMobile ? { height: mobilePanelHeight } : undefined}>

...
export const SEA_LANES = [
  ...
  // 太平洋貿易航路（日付変更線問題のため、東半球と西半球に分割。Japan [139.69, 35.68] を経由）
  { id: 'americas_to_asia', name: '太平洋貿易航路 (米州 - アジア)', type: 'trade', coordinates: [[-79.91, 9.08], [-120.0, 10.0], [-160.0, 15.0], [-179.9, 17.5]] },
  { id: 'americas_to_asia', name: '太平洋貿易航路 (米州 - アジア)', type: 'trade', coordinates: [[179.9, 17.5], [160.0, 20.0], [139.69, 35.68], [119.5, 24.5]] }
];
